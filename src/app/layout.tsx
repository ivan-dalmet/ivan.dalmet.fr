...
import { Tomorrow, Rubik, VT323, Manrope } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${fontArgestaDisplay.variable} ${fontBasierCircleMono.variable} ${fontMiami.variable} ${fontTomorrow.variable} ${fontTrashhand.variable} ${fontRubik.variable} ${fontBraille.variable} ${fontVT323.variable} ${fontManrope.variable} overflow-x-hidden bg-background text-foreground antialiased`}
